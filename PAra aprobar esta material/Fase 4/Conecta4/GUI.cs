...
namespace Conecta4
{
    public class GUI
    {
        ...
        /// <summary>
        /// Pide una columna entre min y max (incluidos),
        /// reutilizando la versión sin parámetros.
        /// </summary>
        public static int PideColumna(int min, int max)
        {
            int col;
            do
            {
                col = PideColumna(); // llama al método original
